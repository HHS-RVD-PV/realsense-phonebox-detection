...
def doospositie(coordinaten):
    ...
    rs.config.enable_device_from_file(config, "/home/wouter/Downloads/object_detection4.bag")
    ...
    try:
        while teller<3:
            ...
            # print('y',y)
            # print('z',z)
            print('breedte:',x[1]-x[0],'mm')
            print('hoogte:',y[1]-y[0],'mm')
            if key & 0xFF == ord('q') or key == 27 :
             ...
             pipeline.stop()
             if coordinaten == 1:
                 return Coordinates[0], dist
             else:
                 return dist
# doos, diepte = doospositie(coordinaten=1)
# print(doos)
# print(diepte)
